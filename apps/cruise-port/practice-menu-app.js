...
import { bindSyncCenterActions, renderSyncCenter } from './sync-center-ui.js?v=0.35.13';
import { createSyncCenterOrchestrator } from './sync-center-orchestrator.js?v=0.35.13';
import {
    openSyncCenter,
    restoreInitialSyncCenterRoute,
    returnToSyncCenterSource
} from './sync-center-navigation.js?v=0.35.13';
import {
