...
const PRACTICE_CALENDAR_ICON_SHAPES = Object.freeze({
    ...
    live: [['path', { d: 'M3.7 17.8l7.3-7.3-.6-.6c-1.2-1.2-1.2-3.1 0-4.4l3.4-3.4c2-2 5.2-2 7.2 0l.9.9c2 2 2 5.2 0 7.2l-3.4 3.4c-1.3 1.2-3.2 1.2-4.4 0l-.6-.6-6.2 7.4c-.9 1.1-2.5 1.2-3.5.2-.9-.9-.7-1.9.1-2.8z', fill: 'currentColor', stroke: 'none' }]],
