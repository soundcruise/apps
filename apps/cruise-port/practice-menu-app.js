...
} from './sync-center-controller.js?v=0.65.0';
import { bindSyncCenterActions, markAppRowsChecking, renderSyncCenter } from './sync-center-ui.js?v=0.65.0';
...
import { createSyncCenterOrchestrator } from './sync-center-orchestrator.js?v=0.65.0';
import {
    openSyncCenter,
    restoreInitialSyncCenterRoute,
    returnToSyncCenterSource
} from './sync-center-navigation.js?v=0.65.0';
import {
