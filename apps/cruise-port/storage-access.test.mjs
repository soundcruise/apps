...
import { acceptRemoteStorageValues, acceptStorageValues, assertStorageUnchanged, readStorageValue } from './storage-conflict.js?v=0.59.0';
...
test('every storage module imports the current conflict coordinator cache key', () => {
    for (const file of [
        ...
        assert.match(source, /storage-conflict\.js\?v=0\.59\.0/, file);
    }
});
