...
import { SYNC_CENTER_APPS, appSyncStatusPresentation } from './sync-center-controller.js?v=0.51.1';
    ...
    const entries = [
        {
            ...
            subtitle: null,
            icon: `/apps/cruise-port/assets/app-icons/${edition === 'pro' ? 'pro' : 'standard'}/icon-192.png?v=0.51.1`,
...
function showJoinCode(root, result, edition = 'standard', onClose = async () => {}) {
    ...
    if (target) {
        ...
        icon.src = isPortAddition
            ? `/apps/cruise-port/assets/app-icons/${edition === 'pro' ? 'pro' : 'standard'}/icon-192.png?v=0.51.1`
