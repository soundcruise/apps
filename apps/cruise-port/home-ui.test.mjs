...
assert.match(markup, /id="settings-view"[\s\S]*?data-display-size="large"[\s\S]*?data-display-size="standard"[\s\S]*?data-display-size="small"/);
...
assert.match(markup, /id="wishlist-view"[\s\S]*?機能を準備中です/);
...
for (const [size, columns] of [['large', 2], ['standard', 4], ['small', 6]]) {
