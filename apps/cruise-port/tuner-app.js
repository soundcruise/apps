...
import { loadTunerMeterVisible, saveTunerMeterVisible } from './tuner-meter-preference.js?v=0.57.2';
...
export function initTuner(root, {
    ...
    function renderReading(reading) {
        ...
        if (targetString && elements.meterVisibility.checked) {
