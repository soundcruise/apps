...
assert(standardHtml.includes('src="../script.js?v=1.14.4"'), 'Standard resolves the shared script from its parent');
...
assert(proHtml.includes('../../shared/pro-gate.js?v=23'), 'Pro gate reference matches the current shared gate asset');
