...
assert(standardHtml.includes('href="../theme.css?v=1.5.0"'), 'Standard resolves the shared theme from its parent');
assert(standardHtml.includes('src="../script.js?v=1.5.0"'), 'Standard resolves the shared script from its parent');
