...
assert(standardHtml.includes('../theme.css?v=' + expectedThemeVersion), 'Standard theme cache-buster is current');
assert(standardHtml.includes('../script.js?v=' + expectedVersion), 'Standard script cache-buster is current');
assert(proHtml.includes('../theme.css?v=' + expectedThemeVersion), 'Pro theme cache-buster is current');
