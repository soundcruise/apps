...
assert.strictEqual(standardManifest.id, '/apps/chord-cruise/', 'Standard has its own installed-app identity');
...
assert(standardHtml.includes('<link rel="manifest" href="manifest.json?v=2">'), 'Standard loads its manifest');
