...
assert(standardHtml.includes('<script src="js/core/feature-access.js?v=0.36.3"></script>'), 'Standard loads feature access');
...
assert(saveEditorSource.includes('href="pro-access.html"'), 'Standard points to the Chord Cruise Pro access page');
