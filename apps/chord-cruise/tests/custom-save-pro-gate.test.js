...
assert(standardHtml.includes('<script src="../js/core/feature-access.js?v=1.15.8"></script>'), 'Standard loads feature access');
...
assert(proHtml.includes('../../shared/pro-gate.js?v=23'), 'the Pro entry continues into the current shared Pro gate');
