...
(async function () {
    ...
    assert(proHtml.includes('../js/sync/sync-turnstile.js?v=1.4.0'), 'Pro loads the production Turnstile provider');
    assert(proHtml.includes('../js/sync/sync-bootstrap.js?v=1.4.0'), 'Pro loads the OFF-first bootstrap');
