...
(async function () {
    ...
    assert(freshProduction.appended.some(function (url) { return url.endsWith('/sync-client.js?v=1.15.4'); }),
    ...
    assert(proHtml.includes('../js/sync/sync-turnstile.js?v=1.15.4'), 'Pro loads the production Turnstile provider');
    assert(proHtml.includes('../js/sync/sync-bootstrap.js?v=1.15.4'), 'Pro loads the OFF-first bootstrap');
    ...
    assert(source.indexOf("loadScript('sync-db.js')") < source.indexOf("loadScript('sync-merge.js?v=1.15.4')"));
    assert(source.indexOf("loadScript('sync-merge.js?v=1.15.4')") < source.indexOf("loadScript('sync-client.js?v=1.15.4')"));
