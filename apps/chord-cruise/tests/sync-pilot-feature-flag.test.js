...
(async function () {
    ...
    assert(proHtml.includes('../js/sync/sync-turnstile.js?v=1.2.1'), 'Pro loads the production Turnstile provider');
    assert(proHtml.includes('../js/sync/sync-bootstrap.js?v=1.2.1'), 'Pro loads the OFF-first bootstrap');
