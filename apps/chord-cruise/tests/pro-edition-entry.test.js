...
assert(proHtml.includes('<link rel="stylesheet" href="../theme.css?v=1.13.0">'), 'Pro entry resolves the shared Chord Cruise theme from its parent directory');
assert(proHtml.includes('<script src="../js/core/feature-access.js?v=1.13.0"></script>'), 'Pro entry loads feature access before application code');
