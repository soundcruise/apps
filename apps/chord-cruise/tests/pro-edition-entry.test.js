...
assert(proHtml.includes('<link rel="stylesheet" href="../theme.css?v=1.2.1">'), 'Pro entry resolves the shared Chord Cruise theme from its parent directory');
assert(proHtml.includes('<script src="../js/core/feature-access.js?v=1.2.1"></script>'), 'Pro entry loads feature access before application code');
