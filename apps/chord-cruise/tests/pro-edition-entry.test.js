...
assert(proHtml.includes('<link rel="stylesheet" href="../theme.css?v=0.37.4">'), 'Pro entry resolves the shared Chord Cruise theme from its parent directory');
assert(proHtml.includes('<script src="../js/core/feature-access.js?v=0.37.4"></script>'), 'Pro entry loads feature access before application code');
