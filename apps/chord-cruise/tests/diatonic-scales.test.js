...
assert.deepStrictEqual(theory.QUALITIES, EXPECTED_QUALITIES, 'core exposes the fixed sixteen-quality metadata including sus4, 7sus4, M7sus4, power5, and no5');
...
assert.deepStrictEqual(
    ...
    Object.keys(EXPECTED_QUALITIES).filter(function (qualityKey) { return qualityKey !== 'sus4' && qualityKey !== '7sus4' && qualityKey !== 'M7sus4' && qualityKey !== 'power5' && qualityKey !== 'no5'; }).sort(),
