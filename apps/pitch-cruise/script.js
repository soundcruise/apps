...
const PITCH_TRAINER_APP_VERSION = '2.22.3';
 ...
 * Type D 固定: かわいい軽め（sine, 高オクターブ, ~0.75s）
 */
...
class Game {
    constructor() {
        ...
        if (document.getElementById('pitch-settings-top')) document.getElementById('pitch-settings-top').addEventListener('click', () => {
