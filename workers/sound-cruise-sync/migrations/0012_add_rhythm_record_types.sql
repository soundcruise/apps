-- M6: add the locally implemented Rhythm adapter record types. Runtime
-- admission remains controlled by SYNC_ALLOWED_APP_IDS, so this additive
-- schema migration does not expose Rhythm in production by itself.

CREATE TABLE sync_records_m6 (
...
INSERT INTO sync_records_m6 SELECT
...
INSERT INTO sync_changes_m6 SELECT
...
ALTER TABLE sync_changes_m6 RENAME TO sync_changes;
