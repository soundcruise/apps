-- M5: expand the shared data-plane tables for the locally implemented Pitch
-- adapter. Runtime admission remains controlled by SYNC_ALLOWED_APP_IDS; this
-- schema change alone cannot make Pitch reachable in production.

CREATE TABLE sync_records_m5 (
...
INSERT INTO sync_records_m5 SELECT
...
INSERT INTO sync_changes_m5 SELECT
...
ALTER TABLE sync_changes_m5 RENAME TO sync_changes;
